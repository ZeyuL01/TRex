...
![vBIT Overview](docs/images/Figure1.png)
...
### Enhanced Region Import

```r
# Import regions with automatic format detection
regions <- import_input_regions(
  file = "peaks.bed",
  format = NULL,  # Auto-detect from file extension
  bin_width = 1000,
  genome = "hg38"
)
```
